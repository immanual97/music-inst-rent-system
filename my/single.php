...
$sql="SELECT * FROM instrument WHERE iid= $inid AND status=1";
	...
	<div class="image">
            <img src="<?php echo $rows['img1'];?>" />
						<div class="home-product-bottom">
								...
								<hr>
								<p style="text-transform: capitalize"> OverView:<?php echo $rows['overview'];?></p>
								<hr>
								<p style="text-transform: uppercase"> Pick:<?php echo $rows['pick'];?></p>
								<p style="text-transform: uppercase"> Kepo:<?php echo $rows['kepo'];?></p>
								<p style="text-transform: uppercase"> Stand:<?php echo $rows['stand'];?></p>
								<p style="text-transform: uppercase"> Foot Pedal:<?php echo $rows['footpedal'];?></p>
								<p style="text-transform: uppercase"> Adapter:<?php echo $rows['adapter'];?></p>
								<p style="text-transform: uppercase"> Stick:<?php echo $rows['stick'];?></p>
								<hr>
								<h3><a href="contact.php?inid=<?php echo htmlentities($rows['iid']);?>">Contact Details</a></h3>
						</div>
    </div>	
  </div>
