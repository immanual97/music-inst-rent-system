...
<div class="submit-ad main-grid-border">
	  <div class="container-2" style="background: white">
			<h2 class="head" style="color: black">Search an Instrument</h2>
...
if(isset($_POST['search']))
	{
		...
		$sqlin="SELECT * FROM instrument WHERE iname='$instrument' AND brand='$brand' AND status=1";
		$results=mysqli_query($con,$sqlin);
	}
