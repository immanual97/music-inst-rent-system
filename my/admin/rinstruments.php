  ...
  <table class="table table-dark">
    ...
    <tbody>
        ...
        <tr>
		  ...
		  <td><img src="../<?php echo  $row['img1']; ?>" class="img-thumbnail" style="height:75px;width:75px;" /></td>
          <td>
                 <form method="POST" action="rinstruments.php">
					<div class="form-group">
						<a href="updateinst.php?inid=<?php echo htmlentities($row['iid']); ?>" class="btn btn-primary">Update</a>
