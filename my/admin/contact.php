...
if(isset($_POST['update']))
{
    $id= $_POST['id'];
	$phone=$_POST['phone'];
	$sql="UPDATE contact SET phone='$phone'WHERE c_id=$id";
	if(mysqli_query($con,$sql))
	{
        ...
        echo '<script>alert("Sorry Try again with other id")</script>';
}
...
<body>
    ...
    <div class="container">
        <div class="row"> 
          <div class="col-lg-7">
            <h1>Modify Or Delete Contact Details</h1>
          </div>          
      </div>
          ...
          <td>
                 <form method="POST" action="contact.php">
					<div class="form-group">
						<?php $_SESSION['id']=$row['c_id'];  ?>
						<input type="submit" name="delete" value="Delete" style="color:white;background:red;" class="btn btn-primary"></input>
					</div>
				 </form>
          </td>
        </tr>
